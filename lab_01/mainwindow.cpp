...
void MainWindow::on_solveButton_clicked()
{
    ...
    tx2 = ui->fTriX->text().toDouble(&tx2Ok);
    tx3 = ui->fTriX->text().toDouble(&tx3Ok);

    ty1 = ui->fTriX->text().toDouble(&ty1Ok);
    ty2 = ui->fTriX->text().toDouble(&ty2Ok);
    ty3 = ui->fTriX->text().toDouble(&ty3Ok);
